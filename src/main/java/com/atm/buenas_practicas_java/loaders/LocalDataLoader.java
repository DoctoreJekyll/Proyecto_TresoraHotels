...
public class LocalDataLoader {
     ...
     */
    public LocalDataLoader(HotelesRepo  hotelesRepo, HabitacionRepo habitacionRepo, ProductoRepo  productoRepo, CategoriaProductoRepo categoriaProductoRepo, UsuarioRepo usuarioRepo
                            , RolRepo rolRepo) {
    ...
    private Producto getProducto2() {
        ...
        producto.setDescripcion("HabitaciÃ³n con cama king size, jacuzzi y vistas al mar");
    ...
    private Producto getProducto3() {
        ...
        producto.setNombre("HabitaciÃ³n doble");
        producto.setDescripcion("HabitaciÃ³n con dos camas individuales y baÃ±o privado");
    ...
    private CategoriaProducto getCategoriaProducto2() {
        CategoriaProducto categoriaProducto = new CategoriaProducto();
        categoriaProducto.setNombre("HabitaciÃ³n categorÃ­a 2");
        categoriaProducto.setDescripcion("HabitaciÃ³n categorÃ­a 2 con mÃ¡s comodidades");
        return categoriaProducto;
    }

    private CategoriaProducto getCategoriaProducto3() {
        CategoriaProducto categoriaProducto = new CategoriaProducto();
        categoriaProducto.setNombre("HabitaciÃ³n categorÃ­a lujo");
        categoriaProducto.setDescripcion("HabitaciÃ³n de lujo con servicios exclusivos");
        return categoriaProducto;
    }
