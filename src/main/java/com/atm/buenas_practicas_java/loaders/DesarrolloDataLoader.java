 ...
 * de entidades para el perfil "desarrollo".
 *
 ...
 *
 * - `@Profile("desarrollo")`: Asegura que esta clase solo se cargue cuando el perfil "desarrollo"
 * esté activo.
 *
 * - `@RequiredArgsConstructor`: Genera un constructor con argumentos requeridos
 * para las dependencias marcadas como `final`.
 */
@Configuration
@Log4j2
@Profile("desarrollo")
...
public class DesarrolloDataLoader {
    ...
    public void loadDataDesarrollo() {
        log.info("Cargando datos iniciales para el perfil 'desarrollo'...");
        loadHoteles();
        loadRoles();
        loadUsuarios();
        loadReservas();
        ...
        loadFacturas();
        loadMiembrosEquipo();
        log.info("Datos iniciales para el perfil 'desarrollo' cargados correctamente.");
    }
    ...
    public void loadMiembrosEquipo() {
        ...
        log.info("Datos del equipo cargados en la base de datos.");
    }
    ...
    private Reserva getReserva1() {
        ...
        // Assuming user with ID 2 exists. In a real scenario, you might want to fetch by email or DNI.
        reserva1.setIdUsuario(usuarioRepo.findByEmail("sophie.dupont@mail.fr").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
    ...
    private Reserva getReserva2() {
        ...
        // Assuming user with ID 5 exists. In a real scenario, you might want to fetch by email or DNI.
        reserva2.setIdUsuario(usuarioRepo.findByEmail("carlos.ruiz@hotelcampo.com").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
    ...
    private Reserva getReserva3() {
        ...
        // Assuming user with ID 1 exists. In a real scenario, you might want to fetch by email or DNI.
        reserva3.setIdUsuario(usuarioRepo.findByEmail("lucas.martinez@mail.com").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
    ...
    private LimpiezaHabitaciones getLimpiezaHabitacion1() {
        ...
        // Assuming user with ID 2 exists. In a real scenario, you might want to fetch by email or DNI.
        limpiezaHabitacion1.setIdUsuario(usuarioRepo.findByEmail("sophie.dupont@mail.fr").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
    ...
    private LimpiezaHabitaciones getLimpiezaHabitacion2() {
        ...
        // Assuming user with ID 2 exists. In a real scenario, you might want to fetch by email or DNI.
        limpiezaHabitacion2.setIdUsuario(usuarioRepo.findByEmail("sophie.dupont@mail.fr").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
    ...
    public Factura getFactura1() {
        ...
        // Assuming user with ID 1 exists. In a real scenario, you might want to fetch by email or DNI.
        factura1.setIdUsuario(usuarioRepo.findByEmail("lucas.martinez@mail.com").orElseThrow(() -> new RuntimeException("Usuario no encontrado")));
        factura1.setIdMetodoPago(metodoPago1);
        factura1.setIdDetalle(7); // This ID might refer to a detail entry, ensure it's valid if used.
